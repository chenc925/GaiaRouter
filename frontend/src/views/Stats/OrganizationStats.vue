<template>
  <div class="organization-stats">
    <a-page-header title="组织统计" @back="$router.push('/stats')" />
...
const stats = computed(() => statsStore.organizationStats[organizationId.value])
...
const handleSearch = async () => {
  ...
  await statsStore.fetchOrganizationStats(organizationId.value, params)
}
